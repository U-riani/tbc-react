...
const NavApp = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Check if scrolling up and not already sticky
      if (currentScrollY < prevScrollY && !isSticky) {
        setSticky(true);
        document.querySelector(".app-header").classList.add("sticky");
      }
      // Check if scrolling down and already sticky
      else if (currentScrollY > prevScrollY && isSticky) {
        setSticky(false);
  ...
  return (
    <>
      {!bodyWidth &&
        [false].map((expand) => (
          <Navbar
            key={expand}
            expand={expand}
            className={`bg-body-black navbar-body width-80 `}
          >
            <Container fluid className="d-flex navbar-container">
              <Navbar.Brand href="#" className="text-light">
                <div
                  data-testid="svgRoot-comp-ktjxmlim"
                  className="aizuI7 TcoJIb comp-ktjxmlim"
                >
                  <svg
                  ...
                  >
                    <g>
                      <g clipPath="url(#b290f575-40bd-4c29-b19c-ded35374c9f9_comp-ktjxmlim)">
                        <path
                          fill="#00ADEE"
              ...
              >
                ...
                <Offcanvas.Body>
                  <Nav className="justify-content-end flex-grow-1 pe-3">
                    <Nav.Link href="#action1 text-light" className="ms-auto">
                      მთავრი
                    </Nav.Link>
                    <Nav.Link href="#action2 text-light" className="ms-auto">
                      TBC IT
                    </Nav.Link>
                    <Nav.Link
                      href="#action2 text-light"
      ...
      {bodyWidth && (
        <Navbar expand="lg" className="app-navbar font-noto-sans py-3 width-80">
          <Container
            fluid
            className="d-flex justify-content-between h-100 px-0 navbar-container"
          >
            <Navbar.Brand
              data-testid="linkElement"
              href="https://www.tbcacademy.ge"
              target="_self"
              className="u9k3ts py-0"
            >
              <div
                data-testid="svgRoot-comp-ktjxmlim"
                className="aizuI7 TcoJIb comp-ktjxmlim"
            ...
            <Navbar.Collapse
              id="basic-navbar-nav"
              className="app-navbar-right-side fs-5"
            >
              <Nav className="ms-auto">
                <Nav.Link href="#home" className="text-light mx-3">
                  მთავარი
                </Nav.Link>
                <Nav.Link href="#link" className="text-light mx-3">
                  TBC IT
                </Nav.Link>
                <Nav.Link href="#link" className="text-info mx-3">
                  TBC x USAID
                </Nav.Link>
                <Nav.Link href="#link" className="text-light mx-3">
                  რისკები
